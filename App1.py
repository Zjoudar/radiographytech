...
# Serve JSON files for each route
...
def login():
    ...
    # Serve the login.json file for GET requests
    return send_from_directory('static/json', 'login.json')

@app.route('/welcome')
def welcome():
    return send_from_directory('static/json', 'welcome.json')

@app.route('/contact')
def contact():
    return send_from_directory('static/json', 'contact.json')

@app.route('/about')
def about():
    return send_from_directory('static/json', 'about.json')

@app.route('/pricing')
def pricing():
    return send_from_directory('static/json', 'pricing.json')

@app.route('/working')
def working():
    return send_from_directory('static/json', 'working.json')

@app.route('/success', methods=['GET', 'POST'])
def success():
    if request.method == 'POST':
        # Handle file upload or link processing logic
        error = ''
        ...
        if request.form:
            ...
            try:
                ...
                # Assuming `predict` is a function that processes the image
            ...
            if not error:
                return jsonify({"img": img, "predictions": predictions})
            else:
    ...
    # Serve the success.json file for GET requests
    return send_from_directory('static/json', 'success.json')
